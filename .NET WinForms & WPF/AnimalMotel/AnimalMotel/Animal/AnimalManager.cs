...
{    
    ...
    public class AnimalManager
    {
        ...
        public string[] GetAnimalList()
        {
            ...
            {
                strOut[i] +=  String.Format("{0, 5}\t{1, 10}\t{2, 23}\t{3, 24}", animalObj.ID, animalObj.Name, animalObj.Age, animalObj.Gender);
                i += 1;
            }
            return strOut;
        }
        ...
        /// </summary>
        internal void AddAnimal(string name, string age, string extraAnimalInfo, GenderType genderType, CategoryType categoryType, Enum specie)
        {
            GetAnimalID();
